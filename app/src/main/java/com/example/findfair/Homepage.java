...
public class Homepage extends AppCompatActivity implements View.OnClickListener{
    ...
    Button FindEbtn,Aboutusbtn,MyJourbtn;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        FindEbtn = (Button) findViewById(R.id.FindEbtn);
        FindEbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(getApplicationContext(), FindEvent.class);
        ...
        MyJourbtn = (Button) findViewById(R.id.MyJourbtn);
        MyJourbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent();
                intent.setClass(getApplicationContext(), MyJourney.class);
